                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('cedula') }}"
                                            name="cedula">
                                        @error('cedula')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('nombres') }}"
                                            name="nombres">
                                        @error('nombres')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('apellidos') }}"
                                            name="apellidos">
                                        @error('apellidos')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('edad') }}"
                                            name="edad">
                                        @error('edad')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
